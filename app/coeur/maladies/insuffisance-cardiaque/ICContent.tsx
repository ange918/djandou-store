    ...
    <>
      ...
      <section className="py-32 px-6" style={{ background: "#080D18" }}>
        <div className="max-w-4xl mx-auto">
          ...
          {/* NYHA table */}
          <motion.div initial={{ opacity: 0, y: 30, filter: "blur(6px)" }} whileInView={{ opacity: 1, y: 0, filter: "blur(0px)" }} viewport={{ once: true }} transition={{ duration: 0.65, ease: "easeOut" as const }} className="mt-12 p-8 rounded-2xl" style={{ background: "#0D1526", border: "1px solid rgba(239,68,68,0.15)" }}>
