      ...
      <section className="py-32 px-6" style={{ background: "#080D18" }}>
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-8" variants={container} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            {[
              { icon: BiGroup, titre: "Prévalence", texte: "17 millions en France · 1,4 milliard dans le monde · 1ère cause de mortalité prématurée" },
              { icon: BiErrorAlt, titre: "Causes", texte: "HTA essentielle >90% des cas (génétique + mode de vie) · HTA secondaire (rénale, surrénale)" },
              { icon: BiTrendingDown, titre: "Pronostic", texte: "Bon si contrôlé. Grave si ignoré : AVC, infarctus, insuffisance rénale terminale" },
            ].map((c, i) => {
              const Icon = c.icon;
              return (
