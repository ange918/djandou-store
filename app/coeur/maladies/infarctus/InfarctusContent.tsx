      ...
      <section className="py-32 px-6" style={{ background: "#080D18" }}>
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-8" variants={container} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            {[
              { icon: BiGroup, titre: "Prévalence", texte: "80 000 IDM/an en France · 10% mortels en moins d'une heure · 1ère cause de mort subite" },
              { icon: BiErrorAlt, titre: "Cause", texte: "Thrombose coronaire sur rupture de plaque athéromateuse. L'artère IVA est la plus souvent touchée." },
              { icon: BiTrendingDown, titre: "Pronostic", texte: "Excellent si angioplastie < 90 min. Grave si retard > 3h (nécrose étendue, IC chronique)" },
            ].map((c, i) => {
              const Icon = c.icon;
              return (
