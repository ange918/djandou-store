      ...
      <section className="py-32 px-6" style={{ background: "#080D18" }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="rounded-[20px] overflow-hidden" style={{ border: "1px solid rgba(255,255,255,0.06)" }}>
            <div className="grid grid-cols-3 px-8 py-4" style={{ background: "rgba(0,201,255,0.06)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
            ...
            {examens.map((ex, i) => (
              ...
              >
                <p className="text-sm font-medium" style={{ color: "#F8FAFC", fontFamily: "var(--font-poppins, Poppins, sans-serif)" }}>{ex.examen}</p>
                <p className="text-sm font-mono" style={{ color: "#10B981" }}>{ex.normale}</p>
                <p className="text-sm" style={{ color: "#94A3B8", fontWeight: 300 }}>{ex.anomalie}</p>
              </div>
            ))}
          </div>

          <div className="mt-12 p-8 rounded-[20px]" style={{ background: "rgba(239,68,68,0.06)", border: "1px solid rgba(239,68,68,0.2)" }}>
