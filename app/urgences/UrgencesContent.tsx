...
import { PhoneIcon, MagnifyingGlassIcon, FaceFrownIcon, ExclamationTriangleIcon } from "@heroicons/react/24/outline";
...
export default function UrgencesContent() {
  ...
  return (
    <div style={{ background: "#050810", minHeight: "100vh" }}>
      ...
      {/* HERO */}
      <section className="relative min-h-[50vh] flex items-center overflow-hidden pt-20" style={{ background: "radial-gradient(ellipse at 30% 50%, #1A0506 0%, #050810 65%)" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        {filtered.length === 0 ? (
          ...
          >
            <FaceFrownIcon className="w-16 h-16" style={{ color: "#64748B" }} />
          ...
          /* Résultats à plat quand recherche active */
