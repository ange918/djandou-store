...
export default function MaladieHero({ gradient, badge, badgeType, title, description, illustration }: MaladieHeroProps) {
  ...
  const badgeBorder = isUrgent ? "rgba(239,68,68,0.3)" : "rgba(249,115,22,0.3)";

  return (
    <section className="relative min-h-[70vh] flex items-center overflow-hidden" style={{ background: gradient }}>
      <div
        className="absolute inset-0 pointer-events-none"
        style={{ opacity: 0.03, backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noise'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noise)'/%3E%3C/svg%3E")` }}
      />
      <motion.div
        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible">
          <motion.div variants={fadeInUp} className="flex items-center gap-3 mb-8 flex-wrap">
            <span
              ...
              style={{ color: "#38BDF8", background: "rgba(56,189,248,0.08)", border: "1px solid rgba(56,189,248,0.2)", fontFamily: "var(--font-poppins, Poppins, sans-serif)" }}
            >
              VOLET POUMONS
            </span>
            <span
          ...
          <motion.h1
            variants={fadeInUp}
            style={{ fontFamily: "var(--font-unbounded, Unbounded, sans-serif)", fontWeight: 900, fontSize: "clamp(2rem, 5.5vw, 4rem)", lineHeight: 1.1, color: "#F8FAFC" }}
          >
            {title}
          </motion.h1>
